...
public class FakeTransferProvider implements TransferProvider {
    ...
    public List<TransferOffer> search(TransferSearchRequest request) {
        TransferOffer offer1 = new TransferOffer(getName(), "1", "Sedan", new java.math.BigDecimal("100.00"), "EUR", 4);
        TransferOffer offer2 = new TransferOffer(getName(), "2", "SUV", new java.math.BigDecimal("150.00"), "EUR", 4);
